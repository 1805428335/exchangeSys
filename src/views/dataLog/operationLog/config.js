...
const PageConfig = {
  ...
  mainTable: {
    ...
    // 子系统表头渲染参数
    tableList: [
      {show: true, prop: 'index1', label: '操作员'},
      {show: true, prop: 'index2', label: '操作描述'},
      {show: true, prop: 'index3', label: '登录ip'},
      {show: true, prop: 'index4', label: '登录地址'},
      {show: true, prop: 'index5', label: '操作类型'},
      {show: true, prop: 'index6', label: '时间'}
      // 操作
      // {

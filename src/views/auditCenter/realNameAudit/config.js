...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index2', label: '姓名'},
      {show: true, prop: 'index3', label: '身份证'},
      {show: true, prop: 'index4', label: '正面'},
      {show: true, prop: 'index4', label: '手持'},
      {show: true, prop: 'index4', label: '反面'},
      // 操作
      {show: true, formType: 'operate', label: '操作',
      buts: [
          {name: '通过', class: 'warning', fn: 'handleEdit', authCode: 'update'},
          {name: '驳回', class: 'danger', fn: 'handleEdit', authCode: 'update'}
      ]}
    ]
  }
};

...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index4', label: '卖家手机号'},
      {show: true, prop: 'index4', label: '订单号'},
      {show: true, prop: 'index4', label: '申诉描述'},
      {show: true, prop: 'index4', label: '申诉图片'},
      {show: true, prop: 'index4', label: '申诉时间'}
      // 操作

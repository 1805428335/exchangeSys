...
const PageConfig = {
  ...
  searchControls: {
    ...
    // 表单配置
    formList: [
      {show: true, prop: 'index1', label: '用户', formType: 'select', span: 24},
      {show: true, prop: 'index1', label: '用户ID', formType: 'input', span: 24}
      ],
    // 是否显示重置按钮
    isReset: true
  },
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index2', label: '昵称'},
      {show: true, prop: 'index3', label: '编号'},
      {show: true, prop: 'index4', label: '注册时间'},
      {show: true, prop: 'index4', label: '状态'},
      {show: true, prop: 'index4', label: '协议标识'},
      {show: true, prop: 'index4', label: '是否会员'},
      {show: true, prop: 'index4', label: '实名状态'},
      // 操作
      {
        show: true, formType: 'operate', label: '操作',
        buts: [
          {name: '用户支付方式', class: 'danger', fn: 'handleDelete', authCode: 'delete'},
          {name: '操作', class: 'danger', fn: 'handleDelete', authCode: 'delete'}
        ], minWidth: '300px'
      }
    ]
  },

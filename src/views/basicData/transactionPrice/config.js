...
const PageConfig = {
  ...
  mainTable: {
    ...
    // 子系统表头渲染参数
    tableList: [
      {show: true, prop: 'index1', label: '币币限价'},
      {show: true, prop: 'index2', label: '法币限价'},
      // 操作
      {
  ...
  mainFormConfig: {
    formList: [
      {
        label: '币币限价', prop: 'code1', span: 24, formType: 'select', isRule: true, maxlength: 20
      }, {
        label: '法币限价', prop: 'code1', span: 24, formType: 'input', isRule: true, maxlength: 20
      }, {

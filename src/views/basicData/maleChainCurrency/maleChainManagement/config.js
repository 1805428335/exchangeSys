...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index2', label: '公链'},
      {show: true, prop: 'index3', label: '简称'},
      {show: true, prop: 'index4', label: '冷钱包地址'},
      {show: true, prop: 'index5', label: '热钱包地址'},
      // 操作
      {
        ...
        buts: [
          ...
          {name: '冷钱包UTXO', class: 'danger', fn: 'handleEdit', authCode: 'delete'},
          {name: '热钱包UTXO', class: 'danger', fn: 'handleEdit', authCode: 'delete'}
        ], minWidth: '300px'
      }
    ]
  },

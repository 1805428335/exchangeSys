...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index1', label: 'nativeid'},
      // 操作
      {
  ...
  mainFormConfig: {
    formList: [
      {
        label: '名称', prop: 'code1', span: 24, formType: 'input', isRule: true, maxlength: 20
      },
      {
        label: 'native', prop: 'code1', span: 24, formType: 'input', isRule: true, maxlength: 20
      }
    ]
  }
};

...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index2', label: 'Native'},
      {show: true, prop: 'index3', label: '获取Token'},
      {show: true, prop: 'index4', label: '发送Token'},
      {show: true, prop: 'index4', label: '应用名称'},
      {show: true, prop: 'index4', label: '副标题'},
      {show: true, prop: 'index4', label: '链接类型'},
      {show: true, prop: 'index4', label: '授权时间'},
      {show: true, prop: 'index4', label: '状态'},
      {show: true, prop: 'index4', label: '是否固定'},
      {show: true, prop: 'index4', label: '是否授权'},
      {show: true, prop: 'index4', label: '标签'},
      {show: true, prop: 'index4', label: '优先级'},
      // 操作
      {

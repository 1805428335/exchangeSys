...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index2', label: '冷钱包账户'},
      {show: true, prop: 'index3', label: '热钱包账户'},
      {show: true, prop: 'index4', label: '节点状态'},
      {show: true, prop: 'index4', label: '节点块高'},
      {show: true, prop: 'index4', label: '冷钱包余额'},
      {show: true, prop: 'index4', label: '热钱包余额'},
      // 操作
      {
        show: true, formType: 'operate', label: '操作',
        buts: [
          {name: '冷钱包在线查询', class: 'warning', fn: 'handleEdit', authCode: 'update'},
          {name: '热钱包在线查询', class: 'warning', fn: 'handleEdit', authCode: 'update'}
        ], minWidth: '240px'
      }
    ]
  },

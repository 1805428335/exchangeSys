...
const PageConfig = {
  ...
  mainTable: {
    ...
    // 子系统表头渲染参数
    tableList: [
      {show: true, prop: 'index1', label: '用户id'},
      {show: true, prop: 'index2', label: '天累计'},
      {show: true, prop: 'index3', label: '月累计'},
      {show: true, prop: 'index4', label: '年累计'},
      // 操作
      {
    ...
    formList: [
      {
        ...
        label: '月累计', prop: 'index3', span: 24, formType: 'input', isRule: true, maxlength: 20
      }, {
        label: '年累计', prop: 'index4', span: 24, formType: 'input', isRule: true, maxlength: 20
      }
    ]
  }
};

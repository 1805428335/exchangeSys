...
const PageConfig = {
  ...
  mainTable: {
    ...
    tableList: [
      ...
      {show: true, prop: 'index6', label: '支付方式'},
      {show: true, prop: 'index7', label: '姓名'},
      {show: true, prop: 'index8', label: '银行卡号'},
      {show: true, prop: 'index9', label: '开户行'},
      {show: true, prop: 'index10', label: '状态'},
      {show: true, prop: 'index11', label: '处理人工客服id'},
      {show: true, prop: 'index12', label: '收款二维码'},
      {show: true, prop: 'index13', label: '支付币种id'},
      {show: true, prop: 'index14', label: '支付币种数量'},
      {show: true, prop: 'index15', label: '手续费'}
      // 操作
      // {

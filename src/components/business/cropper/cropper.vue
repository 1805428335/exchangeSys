 ...
 * @LastEditTime: 2020-11-19 13:20:23
	...
	<div class="wrapper">
		...
		<div class="content">
			<div class="show-info">
                ...
                <div style="flex:5">
                    ...
                    <div class="test-button">
                      <!-- 上传签名图 -->
                        <label class="btn" for="uploads">上传签名图</label>
                        ...
                        <!-- 向左旋转 -->
                        <button v-if="this.option.img" @click="rotateLeft" class="btn">向左旋转90°</button>
                        <!-- 向右旋转 -->
                        <button v-if="this.option.img" @click="rotateRight" class="btn">向右旋转90°</button>
                    </div>
                </div>
          ...
          <div style="text-align: center;"  v-if="this.option.img">
            <!-- 保存签名 -->
              <a @click="down('base64')" class="btn">保存签名</a>

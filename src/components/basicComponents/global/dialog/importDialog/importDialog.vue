<template>
    <el-dialog
        :title="dialogConfig.title || defaultConfig.title"
        :append-to-body="dialogConfig.appendBody || defaultConfig.appendBody"
        :center="dialogConfig.center || defaultConfig.center"
        :top="dialogConfig.top || defaultConfig.top"
        :visible.sync="isDialogVisible"
        :width="dialogConfig.width || defaultConfig.width"
        :before-close="handleClose">
        <div :style="{height: offsetHeight + 'px'}" class="dialog-body">
            <div class="header-button">
                <el-button class="urgent" type="primary" icon="el-icon-delete"
                    size="small" @click="handleDialogStatus('delete')">	批量删除
                </el-button>
            </div>
            <div class="cons">
            ...
            <div class="footer">
                <el-button class="urgent" type="primary" icon="el-icon-circle-close"
                    size="small" @click="handleDialogStatus('close')">取 消
                </el-button>
                <el-button size="small" type="primary" icon="el-icon-circle-check"
                    @click="handleDialogStatus('save')" v-fast-click>确定
                </el-button>
            </div>
        </div>
    </el-dialog>
